...
class TestWp1Reports(unittest.TestCase):
    def setUp(self):
        ...
        with open(self.gvcf,'w', encoding="ascii") as gvcf:
            ...
            gvcf.write("\n")
            gvcf.write(r"chr2	29445270	.	A	C,<NON_REF>	.	.	AS_SB_TABLE=449,168|2,2|0,0;DP=643;ECNT=33;MBQ=36,14,0;MFRL=193,210,0;MMQ=60,60,60;MPOS=36,50;POPAF=7.30,7.30;TLOD=-2.431e+00,-2.428e+00	GT:AD:AF:DP:F1R2:F2R1:SB	0/1/2:617,4,0:1.895e-03,1.858e-03:621:278,0,0:304,0,0:449,168,2,2")
            gvcf.write("\n")
            ...
            gvcf.write("\n")
            gvcf.write(r"chr2	29445273	.	GT	TG,<NON_REF>	.	.	AS_SB_TABLE=460,168|0,0|0,0;DP=628;ECNT=33;MBQ=32,0,0;MFRL=193,0,0;MMQ=60,60,60;MPOS=50,50;POPAF=7.30,7.30;TLOD=-2.432e+00,-2.432e+00	GT:AD:AF:DP:F1R2:F2R1:PGT:PID:PS:SB	0|1|2:628,0,0:1.844e-03,1.844e-03:628:291,0,0:309,0,0:0|1:29445255_G_C:29445255:460,168,0,0")
            gvcf.write("\n")
            gvcf.write(r"chr2	29445274	.	T	G,<NON_REF>	.	.	AS_SB_TABLE=453,162|2,1|0,0;DP=626;ECNT=33;MBQ=32,14,0;MFRL=193,195,0;MMQ=60,60,60;MPOS=47,50;POPAF=7.30,7.30;TLOD=-2.246e+00,-2.255e+00	GT:AD:AF:DP:F1R2:F2R1:SB	0/1/2:615,3,0:1.911e-03,1.851e-03:618:280,0,0:297,0,0:453,162,2,1")
            gvcf.write("\n")
            gvcf.write(r"chr2	29445275	.	C	<NON_REF>	.	.	.	GT:AD:DP:TLOD	0/0:605,3:608:-5.996e+00")
            gvcf.write("\n")
            gvcf.write(r"chr2	29445276	.	T	G,<NON_REF>	.	.	AS_SB_TABLE=458,163|0,0|0,0;DP=624;ECNT=33;MBQ=36,0,0;MFRL=193,0,0;MMQ=60,60,60;MPOS=50,50;POPAF=7.30,7.30;TLOD=-2.430e+00,-2.430e+00	GT:AD:AF:DP:F1R2:F2R1:SB	0/1/2:621,0,0:1.860e-03,1.860e-03:621:282,0,0:291,0,0:458,163,0,0")
            gvcf.write("\n")
            ...
            gvcf.write("\n")
            gvcf.write(r"chr2	29445279	.	G	C,<NON_REF>	.	.	AS_SB_TABLE=451,143|0,0|0,0;DP=594;ECNT=33;MBQ=36,0,0;MFRL=199,0,0;MMQ=60,60,60;MPOS=50,50;POPAF=7.30,7.30;TLOD=-2.416e+00,-2.416e+00	GT:AD:AF:DP:F1R2:F2R1:SB	0/1/2:594,0,0:1.916e-03,1.916e-03:594:250,0,0:271,0,0:451,143,0,0")
            gvcf.write("\n")
            ...
            gvcf.write("\n")
            gvcf.write(r"chr8	145738767	.	CG	C,<NON_REF>	.	.	AS_SB_TABLE=40,6|787,762|0,0;DP=1687;ECNT=41;MBQ=20,20,0;MFRL=169,152,0;MMQ=60,60,60;MPOS=31,50;POPAF=7.30,7.30;TLOD=3010.36,-2.692e+00	GT:AD:AF:DP:F1R2:F2R1:SB	0/1/2:46,1549,0:0.998,9.666e-04:1595:24,753,0:16,761,0:40,6,787,762")
            gvcf.write("\n")
            gvcf.write(r"chr8	145738768	.	G	C,<NON_REF>	.	.	AS_SB_TABLE=372,701|428,46|0,0;DP=1680;ECNT=41;MBQ=14,20,0;MFRL=142,162,0;MMQ=60,60,60;MPOS=30,50;POPAF=7.30,7.30;TLOD=-2.582e+00,-2.546e+00	GT:AD:AF:DP:F1R2:F2R1:SB	0/1/2:1073,474,0:0.333,2.407e-03:1547:0,22,0:0,16,0:372,701,428,46")
            gvcf.write("\n")
            ...
            gvcf.write("\n")
            gvcf.write(r"chr8	145738772	.	A	C,<NON_REF>	.	.	AS_SB_TABLE=865,812|8,4|0,0;DP=1717;ECNT=41;MBQ=20,14,0;MFRL=152,202,0;MMQ=60,60,60;MPOS=20,50;POPAF=7.30,7.30;TLOD=-2.740e+00,-2.730e+00	GT:AD:AF:DP:F1R2:F2R1:SB	0/1/2:1677,12,0:9.536e-04,9.240e-04:1689:705,2,0:745,0,0:865,812,8,4")
            gvcf.write("\n")
    ...
    def test_filtered_mutation_creation_annovar(self):
        ...
        generate_filtered_mutations("sample1", "variant_caller", report, levels, self.hotspot, self.vcf_vep + ".gz" , self.gvcf + ".gz", self.reference)
        self.maxDiff = 10000
        ...
        report = os.path.join(self.tempdir,"filtered.report")
        generate_filtered_mutations("sample1", "variant_caller", report, levels, self.hotspot, self.vcf_vep + ".gz" , self.gvcf + ".gz", self.reference, "tests/utils/files/report_columns_vep.yaml")
        with open(report, 'r') as report_result:
            head = report_result.readline()
            self.assertEqual(head.rstrip(), "\t".join(["sample", "chr", "start", "end", "report", 'gvcf_depth', 'Analyzable', 'Min_read_depth300', 'Gene', 'Variant_type', 'Consequence', 'Callers', 'Comment']))
            result = report_result.readlines()
            self.assertEqual(len(result),11)
            self.assertEqual(result[0].rstrip(),"sample1	NC_000002.11	29445270	29445270	G	A	1-hotspot	620	359	4	yes	ok	ALK	protein_coding	synonymous_variant	vardict	resistance_mutation")
            self.assertEqual(result[1].rstrip(),"sample1	NC_000007.13	140498358	140498361	CTTT	C	2-indel	0	27	4	not analyzable	low	BRAF	protein_coding	intron_variant	mutect2	-")
            self.assertEqual(result[2].rstrip(),"sample1	NC_000007.13	140498361	140498361	-	-	hotspot	0	-	-	not analyzable	low	-	-	-	-	-")
            self.assertEqual(result[3].rstrip(),"sample1	NC_000007.13	140453136	140453136	-	-	hotspot	0	-	-	not analyzable	low	-	-	-	-	-")
            self.assertEqual(result[4].rstrip(),"sample1	NC_000007.13	116412043	116412043	-	-	hotspot	0	-	-	not analyzable	low	-	-	-	-	-")
            self.assertEqual(result[5].rstrip(),"sample1	NC_000002.11	29445272	29445272	-	-	region_all	221	-	-	yes	low	-	-	-	-	-")
            self.assertEqual(result[6].rstrip(),"sample1	NC_000002.11	29445277	29445277	-	-	region_all	182	-	-	yes	low	-	-	-	-	-")
            self.assertEqual(result[7].rstrip(),"sample1	NC_000008.11	145738767	145738767	G	C	3-check	1571	5	27	yes	ok	LRRC14	protein_coding	upstream_gene_variant	vardict	-")
            self.assertEqual(result[8].rstrip(),"sample1	NC_000008.11	145738776	145738776	-	-	region_all	0	-	-	not analyzable	low	-	-	-	-	-")
            self.assertEqual(result[9].rstrip(),"sample1	NC_000008.11	145742513	145742513	A	G	3-check	0	0	839	not analyzable	low	RECQL4	protein_coding	synonymous_variant	vardict,mutect2	-")
            self.assertEqual(result[10].rstrip(),"sample1	NC_000002.11	29445281	29445281	G	A	4-other	520	284	3	yes	ok	ALK	protein_coding	splice_region_variant&intron_variant	vardict	-")
