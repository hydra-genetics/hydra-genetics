    ...
    def test_init_pacbio_bams(self):
        ...
        try:
            creator = CreateLongReadInputFiles(
                ...
                outdir=self.out_dir,
                platform="PACBIO" # Case insensitive in CreateLongReadInputFiles? 
                                  # Looking at create.py: platform is compared exactly. 
                                  # But CreateLongReadInputFiles uses PACBIO as a non-ONT toggle.
            )
            creator.init()
